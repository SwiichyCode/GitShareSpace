...
DB_CONTAINER_NAME="git_share_space-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=git_share_space -d -p 5432:5432 docker.io/postgres
